...
public class Offset extends InstantAction {
	...
	public static final String PARAMETER_OFFSETX = Settings.getString("shimeji.mapper.offset_x","X");

	private static final int DEFAULT_OFFSETX = 0;

	public static final String PARAMETER_OFFSETY = Settings.getString("shimeji.mapper.offset_y","Y");
