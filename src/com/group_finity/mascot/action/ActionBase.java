...
public abstract class ActionBase implements Action {
	...
	public static final String PARAMETER_DURATION = Settings.getString("shimeji.mapper.duration","長さ");

	private static final boolean DEFAULT_CONDITION = true;

	public static final String PARAMETER_CONDITION = Settings.getString("shimeji.mapper.condition","条件");
	...
	private String getName() throws VariableException {
		return this.eval(Settings.getString("shimeji.mapper.name","名前"), String.class, null);
	}
