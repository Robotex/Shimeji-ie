...
public abstract class BorderedAction extends ActionBase {
	...
	private static final String PARAMETER_BORDERTYPE = Settings.getString("shimeji.mapper.border_type","枠");

	public static final String DEFAULT_BORDERTYPE = null;

	public static final String BORDERTYPE_CEILING = Settings.getString("shimeji.mapper.ceiling","天井");

	public static final String BORDERTYPE_WALL = Settings.getString("shimeji.mapper.wall","壁");

	public static final String BORDERTYPE_FLOOR = Settings.getString("shimeji.mapper.floor","地面");
